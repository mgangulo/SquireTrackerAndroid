...
class SpecialConvoAdapter(
    ...
    override fun onBindViewHolder(holder: SpecialConvoAdapter.ViewHolder, position: Int) {
        ...
        if (data is Int){
            ...
            holder.hintText?.setTypeface(holder.hintText!!.getTypeface(), Typeface.NORMAL)
            holder.sequenceText?.setTypeface(holder.sequenceText!!.getTypeface(), Typeface.NORMAL)
        }
    }
